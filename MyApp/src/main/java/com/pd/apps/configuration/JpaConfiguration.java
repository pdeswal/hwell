package com.pd.apps.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.pd.apps.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.pd.apps.model" });
